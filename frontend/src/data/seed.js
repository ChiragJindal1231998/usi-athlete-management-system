...
export const ATHLETES_SEED = [
  ...
  { id: "ATH-040", name: "Ritu Kapoor", age: 18, sport: "Athletics", event: "800m", squad: "Mid distance", coach: "Rajesh Bhat", physio: "Dr Rao", status: "available", readiness: 70, wellness: { sleep: 72, soreness: 68, hrv: 70, energy: 70, mood: 70 }, acwr: 1.19, docsVerified: false, onboarding: "invited", inviteCode: "USI-H040-RITU", tags: ["Development squad"], talentScore: 68, nutritionAdherence: 75 },
];
